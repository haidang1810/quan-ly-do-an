...
var form_delete = document.getElementsByClassName("form-delete");
for(i=0;i<form_delete.length;i++){
    form_delete[i].addEventListener('submit', function(e){
        e.preventDefault();    
        Swal.fire({
            title: 'Bạn có chắc muốn xoá?',
            text: "Bạn sẽ không thể khôi phục dữ liệu sau khi xoá!",
            icon: 'warning',
