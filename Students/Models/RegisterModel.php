<?php
    ...
    if(isset($_POST['id'])&&isset($_POST['mssv'])) {
        ...
        echo "<tbody>";
            while($rowLop = $resultLop->fetch_assoc()){
                ...
                //
                $check = "SELECT * FROM sinhvien_hocphan WHERE Mssv='$mssv' AND MaLopHP='".$rowLop['MaLopHP']."'";
                ...
                if($resultCheck->num_rows <= 0 && $resultHKNH->num_rows > 0){
                    ...
                    if($rowHKNH['TrangThai']==1){
                        ...
                        echo "</button>";
                        echo " <input type='hidden' value='".$rowLop['MaLopHP']."' name='MaLopHP' class='MaLopHP'>";
                        echo "</form>";
                    }
                }
                echo "</td>";
    ...
    if(isset($_POST['maLopHP'])&&isset($_POST['mssv'])){
        include("../../public/config.php");
        global $conn;
        $maLop = $_POST['maLopHP'];
        $mssv = $_POST['mssv'];
